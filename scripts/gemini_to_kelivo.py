...
示例:
    python3 gemini_to_kelivo.py example_account_id ~/Downloads/kelivo.zip
    python3 gemini_to_kelivo.py example_account_id --max-json 5MB --max-upload 10MB
"""
...
def convert_account(account_id: str, output_path: Path,
    ...
    # ── 写 ZIP ──────────────────────────────────────────────────────────────
    multi  = len(bins) > 1
    stem   = output_path.stem    # e.g. "kelivo_backup_redacted_user_20260228T210549"
